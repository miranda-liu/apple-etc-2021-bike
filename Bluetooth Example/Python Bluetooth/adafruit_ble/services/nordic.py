...
class UARTService(Service):
    ...
    # uuid = VendorUUID("CIRCUITPY_UUID")
    # uuid=VendorUUID("6E400001-B5A3-F393-E0A9-E50E24DCUUID")
    uuid=VendorUUID("6E400001-B5A3-F393-E0A9-E50E24DCCA9E")
    _server_tx = StreamOut(
        # uuid = VendorUUID("CIRCUITPY_Server_TX"),
        # uuid = VendorUUID("CIRCUITP-SERV-TX00-0000-000000000000"),
        uuid=VendorUUID("6E400003-B5A3-F393-E0A9-E50E24DCCA9E"),
        timeout=1.0,
        buffer_size=64,
    )
    _server_rx = StreamIn(
        # uuid = VendorUUID("CIRCUITPY_Server_RX"),
        # uuid = VendorUUID("CIRCUITP-SERV-RX00-0000-000000000000"),
